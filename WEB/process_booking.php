     ...
     if (!$result_requirement || pg_num_rows($result_requirement) === 0) {
         ...
         if (!isset($redirect)) {
             ...
             if (!$check) {
                 ...
                 if ($insert) {
                     $message = "Booking successful! Destination ID: $id_destino from $booking_begin to $booking_end.<br>" ;
                     $success = true;
                     $redirect = "index.php";
                 } else {
    ...
    <main class="container">
      <div class="login-container">
        ...
        <p style="text-align: center; margin-top: 10px;">
          You will be redirected shortly...<br><br><br><br>   
        </p>
        <a href="<?= $redirect ?>" class="button-return">Click here if not redirected</a>
      </div>
    </main>
