<?php
//PONER VUESTRO USERNAME Y PASS DE POSTGRES EN "DB_Conection.php" QUE HAY EN LA CARPETA WEB. ES VUESTRO CONFIG INDIVIDUAL, ESTA AÑADIDO AL .gitignore
$host = "localhost"; // <------ Configurar el local host con xampp
$port = "5432"; // <------- Puerto de entrada postgres
$dbname = "Tavel_Site_DataBase"; // <------- Nombre de la base de datos.
